...
public partial class OnlineLearningDbContext : IdentityDbContext<Account>
{
	...
	private void ConfigureSeekData(ModelBuilder modelBuilder)
	{
		...
		new CourseCategory { CategoryId = 1, Name = "Artificial Intelligence" },
		...
		modelBuilder.Entity<Course>().HasData(
			...
			new Course
			{
				...
				CreateDate = DateOnly.FromDateTime(DateTime.UtcNow.AddDays(-15)),
				CategoryId = 3,
				Status = CourseStatus.Pending,
				Price = 20000
			},
			new Course
			{
				...
				CreateDate = DateOnly.FromDateTime(DateTime.UtcNow.AddDays(-45)),
				CategoryId = 4,
				Status = CourseStatus.Approved,
				Price = 25000
			},
			new Course
			{
				...
				CreateDate = DateOnly.FromDateTime(DateTime.UtcNow.AddDays(-60)),
				CategoryId = 5,
				Status = CourseStatus.Pending,
				Price = 30000
			}
